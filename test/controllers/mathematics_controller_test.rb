...
class MathematicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mathematic" do
    assert_difference('Mathematic.count') do
      post mathematics_url, params: { mathematic: { message: @mathematic.message, title: @mathematic.title } }
    end
  ...
  test "should update mathematic" do
    patch mathematic_url(@mathematic), params: { mathematic: { message: @mathematic.message, title: @mathematic.title } }
